				...
				<div className="img-banner-right">
					<div className="swiper slider-sw-home2">
						<Swiper {...swiperOptions} className="swiper-wrapper">
							...
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-4.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-5.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-6.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-7.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-9.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-10.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-11.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-12.jpg" alt="images" />
								</div>
							</SwiperSlide>
							<SwiperSlide>
								<div className="slider-home2">
									<img src="/images/slider/slider-2-13.jpg" alt="images" />
								</div>
							</SwiperSlide>
						</Swiper>
					</div>
