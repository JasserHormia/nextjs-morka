          ...
          >
            ...
            >
              ...
              <li className="nav-tab-item" onClick={() => handleTab(6)}>
                <a
                  className={
                    isTab == 6 ? "nav-link-item active" : "nav-link-item"
                  }
                  data-bs-toggle="tab"
                >
                  Commercial
            ...
            <div className="tab-content">
              ...
              >
                        ...
                        <div className="content">
                          <div className="h7 text-capitalize fw-7">
                            <Link href="/property-details-v1" className="link">
                              {" "}
                              4 BR+ Maid Villa / Modern Style / Gated Community
                            </Link>
                          </div>
                          <div className="desc">
                            <i className="fs-16 icon icon-mapPin" />
                            <p>
                              The Hartland Villas Dubai, Mohammed Bin Rashid
                              City
                              <br /> Sobha Hartland{" "}
                            </p>{" "}
                          </div>
                    ...
                    <div className="homeya-box">
                      <div className="archive-top">
                        ...
                        <div className="content">
                          <div className="h7 text-capitalize fw-7">
                            <Link href="/property-details-v1" className="link">
                              Waterfront Luxury 2 Bedrooms apartment and Full
                              Furnishings
                            </Link>
                          </div>
                          <div className="desc">
                            ...
                            <p>
                              ...
                              <br />
                              The Address Jumeirah Resort and Spa
                            </p>{" "}
                          </div>
                          <ul className="meta-list">
                            <li className="item">
                      ...
                      <div className="archive-top">
                        ...
                        <div className="content">
                          <div className="h7 text-capitalize fw-7">
                            <Link href="/property-details-v1" className="link">
                              {" "}
                              Stunning , Luxury Fully <br /> furnished Villa
                            </Link>
                          </div>
                          <div className="desc">
                            <i className="fs-16 icon icon-mapPin" />
                            <p>
                              Garden Homes Frond L Dubai
                              <br /> Palm Jumeirah <br />
                              Garden Homes
                            </p>{" "}
                          </div>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6">
                    <div className="homeya-box">
                      <div className="archive-top">
                        ...
                        <div className="content">
                          <div className="h7 text-capitalize fw-7">
                            <Link href="/property-details-v3" className="link">
                              Exclusive Large 2BR| VACANT SOON | Burj views
                            </Link>
                          </div>
                          <div className="desc">
                            <i className="fs-16 icon icon-mapPin" />
                            <p>
                              Reehan 1, Sheikh Mohammed bin Rashid Boulevard
                              <br />
                    ...
                    <div className="homeya-box">
                      <div className="archive-top">
                        ...
                        <div className="content">
                          <div className="h7 text-capitalize fw-7">
                            <Link href="/property-details-v1" className="link">
                              Great price | Corner unit | Burj Khalifa view
                            </Link>
                          </div>
                          <div className="desc">
                            <i className="fs-16 icon icon-mapPin" />
                    ...
                    <div className="homeya-box">
                      <div className="archive-top">
                        ...
                        <div className="content">
                          <div className="h7 text-capitalize fw-7">
                            <Link href="/property-details-v1" className="link">
                              VACANT | Single row villa | Amazing location
                            </Link>
                          </div>
                          <div className="desc">
                            <i className="fs-16 icon icon-mapPin" />
                ...
                <div className="text-center">
                  <Link href="/sidebar-grid" className="tf-btn primary size-1">
                    View All Properties
                  </Link>
                </div>
              </div>
