										...
										<div className="homeya-box">
											<div className="archive-top">
												...
												<div className="content">
													...
													<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>The Hartland Villas Dubai, Mohammed Bin Rashid City, Sobha Hartland</p> </div>
										...
										<div className="homeya-box">
											<div className="archive-top">
												...
												<div className="content">
													...
													<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>Jumeirah Gate Tower 1 Dubai, Jumeirah Beach Residence, The Address Jumeirah Resort and Spa</p> </div>
													<ul className="meta-list">
														<li className="item">
															<i className="icon icon-bed" />
															<span>2</span>
									...
									<div className="col-xl-4 col-lg-6 col-md-6">
										<div className="homeya-box">
											<div className="archive-top">
												...
												<div className="content">
													<div className="h7 text-capitalize fw-7"><Link href="/property-details-v2" className="link">Stunning | Luxury | Fully furnished</Link></div>
													<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>Garden Homes Frond L Dubai, Palm Jumeirah, Garden Homes</p> </div>
													<ul className="meta-list">
														<li className="item">
															<i className="icon icon-bed" />
															<span>5</span>
										...
										<div className="homeya-box">
											<div className="archive-top">
												...
												<div className="content">
													...
													<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>Reehan 1 - Sheikh Mohammed bin Rashid Boulevard - Dubai - United Arab Emirates</p> </div>
													<ul className="meta-list">
														<li className="item">
															<i className="icon icon-bed" />
															<span>2</span>
									...
									<div className="col-xl-4 col-lg-6 col-md-6">
										<div className="homeya-box">
											<div className="archive-top">
												...
												<div className="content">
													<div className="h7 text-capitalize fw-7"><Link href="/property-details-v4" className="link">Great price | Corner unit | Burj Khalifa view</Link></div>
													<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>Mohammed Bin Rashid Al Maktoum City District One</p> </div>
													<ul className="meta-list">
														<li className="item">
															<i className="icon icon-bed" />
															<span></span>
											...
											<div className="archive-bottom d-flex justify-content-between align-items-center">
												...
												<div className="d-flex align-items-center">
													<h6>11,15M AED</h6>
													<span className="text-variant-1">Off Plan</span>
												</div>
											</div>
										</div>
									</div>
										...
										<div className="homeya-box">
											<div className="archive-top">
												...
												<div className="content">
													...
													<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>Jumeirah Park, Dubai, United Arab Emirates</p> </div>
													<ul className="meta-list">
														<li className="item">
															<i className="icon icon-bed" />
															<span>3</span>
