                ...
                <div className="content-top d-flex justify-content-between align-items-center">
                  <div className="box-name">
                    ...
                    <h4 className="title link">
                      Exclusive 2 Bedrooms |Fully Furnished| Vacant
                    </h4>
                  </div>
                  <div className="box-price d-flex align-items-center">
                    <h4>205,000AED</h4>
                    <span className="body-1 text-variant-1">/Year</span>
                  </div>
                </div>
                <div className="content-bottom">
                  <div className="info-box">
                    ...
                    <ul className="meta">
                      ...
                      <li className="meta-item">
                        <span className="icon icon-bathtub" /> 3 Bathroom
                      </li>
                      <li className="meta-item">
                        <span className="icon icon-ruler" /> 1,404 SqFT
                      </li>
                    </ul>
                  </div>
                  <div className="info-box">
                    ...
                    <p className="meta-item">
                      <span className="icon icon-mapPin" /> BLVD Heights Dubai,
                      Downtown Dubai
                    </p>
                  </div>
                ...
                <div className="col-lg-8">
                  <div className="single-property-element single-property-desc">
                    ...
                    <p className="body-2 text-variant-1">
                      Morka Real Estate is delighted to offer this Fully
                      Furnished 2-bedrooms apartment in Blvd Heights, located in
                      Downtown Dubai.
                    </p>
                    <p className="mt-8 body-2 text-variant-1">
                      - Large Layout - 2 Bedrooms - 3 Washrooms - City View -
                      Balcony - Fully furnished - Fully fitted kitchen - Bright
                      unit - Connected to Dubai Metro - Walking distance to
                      Dubai mall, Opera and Burj Khalifa
                    </p>
                  ...
                  <div className="single-property-element single-property-info">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <div className="inner-box">
                          <span className="label">Bedrooms:</span>
                          <div className="content fw-7">2</div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="inner-box">
                      ...
                      <div className="col-md-6">
                        <div className="inner-box">
                          ...
                          <div className="content fw-7">1,404 SqFt</div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-6">
                        <div className="inner-box">
                          ...
                          <div className="content fw-7">Family</div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="inner-box">
                    ...
                    <ul className="info-map">
                      <li>
                        ...
                        <span className="mt-4 text-variant-1">
                          BLVD Heights Dubai, Downtown Dubai
                        </span>
                      </li>
                      <li>
                    ...
                    <ul className="box-floor" id="parent-floor">
                        ...
                        >
                          ...
                          <ul className="inner-right">
                            <li className="d-flex align-items-center gap-8">
                              <i className="icon icon-bed" />2 Bedrooms
                            </li>
                            <li className="d-flex align-items-center gap-8">
                              <i className="icon icon-bathtub" />3 Bathrooms
                            </li>
                          </ul>
                        </div>
                        <div
                      ...
                      >
                        ...
                        >
                          <div className="inner-left">
                            <i className="icon icon-arr-r" />
                            <span className="fw-7">3D Floor Plan</span>
                          </div>
                          <ul className="inner-right"></ul>
                        </div>
                        <div
                          id="floor-two"
                          className={`${
                  ...
                  <div className="single-property-element single-property-explore">
                    ...
                    <div className="box-img">
                      <iframe
                        ...
                        src="https://www.klapty.com/tour/tunnel/tX50KELvRk"
                        frameborder="0"
                    ...
                    <form action="#" className="box-loan-calc">
                      ...
                      <div className="box-bottom">
                        ...
                        <div className="d-flex gap-4">
                          ...
                          <span className="result h7 fw-7">000.00AED</span>
                        </div>
                      </div>
                    </form>
                  </div>
                    ...
                    <div className="widget-box single-property-contact bg-surface">
                      ...
                      <div className="box-avatar">
                        <div className="avatar avt-100 round">
                          <img src="/images/avatar/ousama.webp" alt="avatar" />
                        </div>
                        <div className="info">
                          <div className="text-1 name">Osamah Zaid</div>
                          <span>1-333-345-6868 test@test.com</span>
                        </div>
                      </div>
