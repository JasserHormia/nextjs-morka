									...
									<div className="contact-info">
										...
										<ul>
											<li className="box">
												...
												<p className="p-16 text-variant-1">Office 2504-3, Prism Tower, Business Bay, Dubai, PO Box 118962
													<br />  United Arab Emirates</p>
											</li>
											<li className="box">
												<div className="text-1 title">Infomation:</div>
												<p className="p-16 text-variant-1">+971 44324415 <br /> Info@morkarealestate.com</p>
											</li>
											<li className="box">
												<div className="text-1 title">Opentime:</div>
												<p className="p-16 text-variant-1">Monday - Thursday: 8:00AM - 5:00PM <br /> Friday - Saturday: 8:00AM - 12:00PM</p>
											</li>
											<li className="box">
												<div className="text-1 title">Follow Us:</div>
												<ul className="box-social">
													<li><Link target="_blank" href="https://www.facebook.com/profile.php?id=61558802877905" className="item" alt="Facebook">
													...
													<li><Link target="_blank" href="https://www.instagram.com/morka.realestate/" className="item" alt="Instagram">
